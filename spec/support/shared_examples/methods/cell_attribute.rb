shared_examples "cell_attribute"  do |method_name, cell_method, expectation={} |
  ...
  it "works" do
    expect_any_instance_of(instance.cells.values.first.class).to receive(cell_method).and_call_original
